...
SETTINGS = {
  :url          => "https://dev-foreman.pontis.local",  # e.g. https://foreman.example.com
  ...
  :ssl_cert     => "/var/lib/puppet/ssl/certs/dev-foreman.pontis.local.pem",    # e.g. /var/lib/puppet/ssl/certs/FQDN.pem
  :ssl_key      => "/var/lib/puppet/ssl/private_keys/dev-foreman.pontis.local.pem"      # e.g. /var/lib/puppet/ssl/private_keys/FQDN.pem
}
